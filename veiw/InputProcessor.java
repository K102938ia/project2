            ...
            if ( chooseMode.equalsIgnoreCase ("LogIn") ) {
                ...
                if ( loginController.loginErrorType () == 1 ) {
                    ...
                    while (inAccount) {
                        ...
                        if ( commend.equalsIgnoreCase ("create post") ) {
                            inPosting = true;
                            System.out.println ("You are in the posting section.");
                            commend = scanner.nextLine ();
                            if ( commend.equalsIgnoreCase ("go back") ) {
                                inPosting = false;
                            } else if ( commend.equalsIgnoreCase ("add text") && inPosting ) {
                                System.out.println ("Enter your post:");
                                String post = scanner.nextLine ();
                                commend = scanner.nextLine ();
                                if ( commend.equalsIgnoreCase ("post") ) {
                                    System.out.println (ManagerBasic.getUsers ());
                                    PostController postController = new PostController ();
                                    postController.addPost (currentAccount, post);
                                    if ( postController.addedPost ) {
                                        System.out.println ("added successfully");
                                        postController.addedPost = false;
                                        inPosting = false;
                                        System.out.println ("type logOut or continue");
                                        commend =scanner.nextLine ();
                                ...
                                } else if ( commend.equalsIgnoreCase ("back") ) {
                                    inPosting = false;
                                }
                            }
                        }
                    ...
                    if ( commend.split ("\\s").length > 1 ) {
                        ...
                        if ( commend.equalsIgnoreCase ("create post") ) {
                            ...
                            if ( commend.equalsIgnoreCase ("go back") ) {
                                ...
                                } else if ( commend.equalsIgnoreCase ("cancel") ) {
                                    inPosting = false;
                                }
                            }
                        }
